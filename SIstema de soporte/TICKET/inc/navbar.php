...
<!-- Lo de abajo reemplaza el logo del hospital.
<a class="navbar-brand" href="index.php"><i></i>&nbsp;&nbsp Sistema de Soporte;</a>
-->

            <a class="navbar-brand" href="index.php"><img src="./img/logoMain.png" alt="Image"><i></i>&nbsp;&nbsp;</a>
        </div>
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            ...
            <ul class=" nav navbar-nav navbar-right">
                <li>
                    <a href="./index.php?view=soporte"><span class="glyphicon glyphicon-home"></span>&nbsp;&nbsp;Soporte técnico</a>
                </li>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title text-center text-primary" id="myModalLabel">Bienvenido a </h4>
            </div>
