<?php if($_SESSION['nombre']!="" && $_SESSION['tipo']=="admin"){ ?>    
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Bienvenido administrador. <br>En esta página se muestran todos los usuarios y administradores registrados en Hospital Amazónico, usted podra eliminarlos si lo desea.</p>
            </div>
          </div>
        </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Lo sentimos esta página es solamente para el área de soporte del Hospital Amazónico</h1>
