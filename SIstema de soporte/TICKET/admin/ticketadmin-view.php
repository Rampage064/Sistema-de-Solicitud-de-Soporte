<?php if( $_SESSION['nombre']!="" && $_SESSION['clave']!="" && $_SESSION['tipo']=="admin"){ ?>
        <div class="container">
          <div class="row">
            ...
            <div class="col-sm-10">
              <p class="lead text-info">Aquí se muestran todos los Tickets que se podrán eliminar, modificar e imprimir.</p>
            </div>
          </div>
        </div>
            <?php
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-7 animated flip">
                    <h1 class="text-danger">Lo sentimos esta página es solamente para administradores de </h1>
