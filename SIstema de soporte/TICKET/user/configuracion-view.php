<?php if(!$_SESSION['nombre']==""&&!$_SESSION['tipo']==""){ 
        ...
        <div class="container">
          <div class="row well">
            <div class="col-sm-3">
              <img src="img/ajustes.png" alt="Image" class="img-responsive">
            </div>
            <div class="col-sm-9 lead">
              <h2 class="text-info">Bienvenido a la configuración de cuenta.</h2>
              <p>Puedes <strong>actualizar los datos</strong> de tu cuenta o puedes <strong>eliminar tu cuenta</strong> permanentemente.</p>
            </div>
          </div><!--Fin row well-->
